/**
* @pollyjs/adapter-node-http v5.0.0
*
...
class HttpAdapter extends Adapter {
  ...
  setupNock() {
    ...
    HTTP_METHODS.forEach(m => {
      ...
      interceptor.intercept(/.*/, m).reply(function (_, _body, respond) {
        ...
        const body = isUtf8Representable_1(requestBodyBuffer) ? requestBodyBuffer.toString('utf8') : requestBodyBuffer;
  ...
  getBodyFromChunks(chunks, headers) {
    ...
    if (isContentEncoded_1(headers)) {
      ...
      return {
        isBinary: true,
        body: stringify$1(hexChunks)
      };
    }

    const buffer = mergeChunks(chunks);
    const isBinaryBuffer = !isUtf8Representable_1(buffer); // The merged buffer can be one of two things:
