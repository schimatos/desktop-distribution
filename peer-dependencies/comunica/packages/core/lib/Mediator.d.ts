...
export declare abstract class Mediator<A extends Actor<I, T, O>, I extends IAction, T extends IActorTest, O extends IActorOutput> implements IMediatorArgs<A, I, T, O> {
     ...
     */
    mediateResult(action: I): Promise<IActorReply<A, I, T, O>>;
    /**
     ...
     */
    protected abstract mediateWithResult(action: I, testResults: IActorReply<A, I, T, O>[]): Promise<IActorReply<A, I, T, O>>;
    /**
     * Mediate for the given action with the given actor test results for the action.
     *
